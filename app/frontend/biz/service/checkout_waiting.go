...
import (
	...
	checkout "github.com/py/biz-demo/gomall/app/frontend/hertz_gen/frontend/checkout"
	"github.com/py/biz-demo/gomall/app/frontend/infra/rpc"
	frontendUtils "github.com/py/biz-demo/gomall/app/frontend/utils"
	rpccheckout "github.com/py/biz-demo/gomall/rpc_gen/kitex_gen/checkout"
	rpcpayment "github.com/py/biz-demo/gomall/rpc_gen/kitex_gen/payment"
)
...
func (h *CheckoutWaitingService) Run(req *checkout.CheckoutReq) (resp map[string]any, err error) {
	...
	_, err = rpc.CheckoutClinet.Checkout(h.Context, &rpccheckout.CheckoutReq{
